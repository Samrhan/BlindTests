    ...
    <div className="bg-gray-800 h-full w-full flex flex-col overflow-y-auto">
      ...
      <div>
        <div className="px-10 w-full flex">
          <button className="bg-red-800 mr-2 text-white p-2.5 mb-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-red-900 text-white">
            Ajouter depuis YouTube
          </button>
          <button className="bg-blue-800 text-white p-2.5 mb-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-900 text-white">
            Sauvegarder
          </button>
        </div>
      </div>
