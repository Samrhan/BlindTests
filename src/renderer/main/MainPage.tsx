...
import Play from './playlists/play/Play';
...
export default function MainPage() {
  ...
  const handleNewPlaylist = (playlist: PlaylistBody) => {
    emit<Playlist>('create-playlist', { playlist }).then(
      (playlist: Playlist) => {
        setPlaylists((playlists) => {
  ...
  const handleEditPlaylist = (playlist: Playlist) => {
    emit<Playlist>('update-playlist', { playlist }).then(
      (playlist: Playlist) => {
        setPlaylists((playlists) => {
            ...
            <Route
              ...
              element={
                <CreateOrEditPlaylist
                  ...
                  findPlaylist={handleFindPlaylist}
                />
              }
            ></Route>
            <Route
